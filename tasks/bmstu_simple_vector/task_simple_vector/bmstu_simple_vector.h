...
public:
  ...
  public:
    ...
    friend pointer to_address(const iterator &it) noexcept { return it.ptr_; }
...
#pragma region Operators
    ...
    friend bool operator==(std::nullptr_t, const iterator &rhs) { return true; }
    ...
    iterator operator+=(const difference_type &n) noexcept { return nullptr; }
